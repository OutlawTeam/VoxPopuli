...
namespace VoxPopuliLibrary.Engine.GraphicEngine
{
    ...
    public class FreeTypeFont
    {
        ...
        public void RenderText(string text, Positron.Positron positron,Vector3 color,float x, float y, float scale, Vector2 dir)
        {
            GL.Disable(EnableCap.DepthTest);
            GL.ActiveTexture(TextureUnit.Texture0);
            GL.BindVertexArray(_vao);
            positron.BaseFont.Use();
            positron.BaseFont.SetVector3("textColor", color);
            positron.BaseFont.SetMatrix4NoTranspose("projection", FontManager.projectionM);
            ...
            foreach (var c in text)
            {
                ...
                positron.BaseFont.SetMatrix4NoTranspose("model", modelM);
