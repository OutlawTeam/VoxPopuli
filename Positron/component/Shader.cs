...
namespace Positron.component
{
    ...
    public class Shader
    {
        ...
        internal Shader(string VertString, string FragString,bool fromText = true)
        {
            // There are several different types of shaders, but the only two you need for basic rendering are the vertex and fragment shaders.
            // The vertex shader is responsible for moving around vertices, and uploading that data to the fragment shader.
            //   The vertex shader won't be too important here, but they'll be more important later.
        ...
        internal int GetAttribs()
        {
            GL.GetProgram(Handle,GetProgramParameterName.ActiveAttributes, out int attributes);
            return attributes;
        }
